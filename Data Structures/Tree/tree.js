...
class BinarySearchTree{
    ...
    // this recursion method is used to inserting the values
    ...
    // Searching the values over the tree
    search(root, value){
        if(!root){
            return false
        }else{
    ...
    // finding minimum value from the tree
    min(root){
       if(!root.left){
        return root.value
       }else{
    ...
    // find the maximum value fram the tree
    max(root){
        if(!root.right){
            return root.value
        }else{
